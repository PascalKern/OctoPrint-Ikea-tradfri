...
"""
# https://github.com/home-assistant-libs/pytradfri/blob/master/examples/example_socket_async.py
...
if args.host not in load_json(CONFIG_FILE) and args.host is None:
    print("Must provide at least IP of gateway!")
    exit(1)
...
#            save_json(CONFIG_FILE, conf)
    ...
    print("Waiting for observation to end (0.1 secs)")
