...
#         self.client = TradfriClient(gw_ip, gw_sec_key)
#         self.loop = asyncio.get_event_loop()
#
#     def get_sockets(self):
#         return self.loop.run_until_complete(self.__async__get_sockets())
#
#     def __async__get_sockets(self):
#         return await self.client.get_sockets()
...
class TradfriClient():
    ...
    def get_sockets(self):
        return asyncio.get_event_loop().run_until_complete(self.__get_sockets__())
